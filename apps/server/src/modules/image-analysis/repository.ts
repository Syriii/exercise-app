...
export interface ImageAnalysisRepository {
  ...
  create(userId: string, mealId: string, contentType: string, stored: StoredTemporaryMedia, expiresAt: Date | null, model: string, promptVersion: string, automatic?: boolean): Promise<MealImageAnalysis>;
