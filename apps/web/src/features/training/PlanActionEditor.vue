...
const props = defineProps<{ item: {
  ...
  targetRepsMax: string | number; targetWeightKg: string; targetDurationSeconds: string | number; targetDistanceMeters: string; measurement?: Measurement;
...
<template>
  <article class="plan-action-editor">
    ...
    <PlanTargetFields :item="item" :measurement="item.measurement" />
